...
from rdptrio.core.type import CompositeType, CallableValue, UInt8, UInt16Le, UInt32Le, String, sizeof, FactoryType, ArrayType, Stream
...
from rdptrio.security import rsa_wrapper as rsa
...
class LicPacket(CompositeType):
    ...
    def __init__(self, message = None):
        ...
        def LicensingMessageFactory():
            ...
            logger.debug("unknown license message : %s"%self.bMsgtype.value)
        ...
        if message is None:
            ...
            raise ValueError("Try to send an invalid license message")
...
class LicenseManager(object):
    ...
    def recv(self, s):
        ...
        #yes get a new license
            ...
            raise ValueError("Not a valid license packet")
    ...
    def sendClientChallengeResponse(self, platformChallenge):
        ...
        if serverChallenge != "T\x00E\x00S\x00T\x00\x00\x00":
            raise ValueError("bad license server challenge")
