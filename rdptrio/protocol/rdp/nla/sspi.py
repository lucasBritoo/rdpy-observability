...
class IAuthenticationProtocol(object):
    ...
    def getNegotiateMessage(self):
        ...
        """
        raise ValueError("%s:%s defined by interface %s"%(self.__class__, "getNegotiateMessage", "IAuthenticationProtocol")) 
    ...
    def getAuthenticateMessage(self, s):
        ...
        """
        raise ValueError("%s:%s defined by interface %s"%(self.__class__, "getAuthenticateMessage", "IAuthenticationProtocol"))
    ...
    def getEncodedCredentials(self):
        ...
        """
        raise ValueError("%s:%s defined by interface %s"%(self.__class__, "getEncodedCredentials", "IAuthenticationProtocol"))
...
class IGenericSecurityService(object):
    ...
    def GSS_WrapEx(self, data):
        ...
        @param data: {str}
        """
        raise ValueError("%s:%s defined by interface %s"%(self.__class__, "GSS_WrapEx", "IGenericSecurityService"))
    ...
    def GSS_UnWrapEx(self, data):
        ...
        @param data: {str}
        """
        raise ValueError("%s:%s defined by interface %s"%(self.__class__, "GSS_UnWrapEx", "IGenericSecurityService"))