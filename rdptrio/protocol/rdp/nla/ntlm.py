...
import rdptrio.protocol.rdp.nla.sspi as sspi
import rdptrio.security.pyDes as pyDes
import rdptrio.security.rc4 as rc4
from rdptrio.security.rsa_wrapper import random
from rdptrio.core.type import CompositeType, CallableValue, String, UInt8, UInt16Le, UInt24Le, UInt32Le, sizeof, Stream
from rdptrio.core import filetimes
...
class NTLMv2SecurityInterface(sspi.IGenericSecurityService):
    ...
    def GSS_UnWrapEx(self, data):
        ...
        if verify != checksum:
            raise ValueError("NTLMv2SecurityInterface : Invalid checksum")
