...
class IStreamListener(object):
    ...
    def recv(self, s):
        ...
        @param s: Stream
        """
        raise ValueError("%s:%s defined by interface %s"%(self.__class__, "recv", "IStreamListener"))
...
class IStreamSender(object):
    ...
    def send(self, data):
        ...
        """
        raise ValueError("%s:%s defined by interface %s"%(self.__class__, "send", "IStreamSender"))
